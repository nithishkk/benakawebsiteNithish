...
//  const TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyRGV0YWlscyI6InZlZXJhbm5hLnJhdmkua3VtYXJAYmVuYWthZ3JvdXBzLmNvbSIsInVzZXJJZCI6IjY0ZDljNjJhYjQ1NjcwYzE4NjNlMGVkOCIsImV4cCI6MTc3Njg1MjQxNX0.IcBujaL-WzpW1mw2EE_2iNSzW0f18GzrKfbJfRskZGA";
...
function CategoryGrid({
    ...
    const fetchCollections = async () => {
      try {
        const data = await apiRequest(
          "https://aapi.benakajewellers.com/getAllCollection"
        );
        setCollections(data || []);
      } catch (err) {
        console.error(err);
  ...
  useEffect(() => {
    const fetchGoldPrice = async () => {
      try {
        const data = await apiRequest(
          "https://capi.benakajewellers.com/getGoldSilverPrices",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
